...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-02-2025 a las 14:27:23
...
INSERT INTO `precios_producto` (`id_precio`, `id_producto`, `id_proveedor`, `precio_costo`, `precio_venta`, `fecha_inicio`, `fecha_fin`, `fecha_captura`, `usuario_captura`, `estatus`) VALUES
(3, 12, 2, 20.00, 25.00, '2025-02-21', '2025-02-28', '2025-02-21 12:13:28', 1, 'Activo'),
(4, 12, 4, 20.00, 30.00, '2025-02-21', '2025-02-25', '2025-02-21 12:13:28', 1, 'Activo'),
(5, 1, 1, 35.00, NULL, '2025-02-23', '2025-03-01', '2025-02-22 17:48:24', 1, 'Activo'),
(6, 1, 4, 45.00, NULL, '2025-02-23', '2025-03-01', '2025-02-22 17:49:52', 1, 'Activo'),
(7, 2, 2, 35.00, NULL, '2025-02-23', '2025-03-01', '2025-02-22 17:51:38', 1, 'Activo'),
(8, 1, 1, 15.00, NULL, '2025-02-23', '2025-03-01', '2025-02-22 17:58:59', 1, 'Activo');
...
ALTER TABLE `precios_producto`
  ...
  ADD KEY `precios_producto_ibfk_3` (`usuario_captura`);
...
ALTER TABLE `precios_producto`
  ...
  ADD CONSTRAINT `precios_producto_ibfk_3` FOREIGN KEY (`usuario_captura`) REFERENCES `usuarios` (`id_usuario`);
